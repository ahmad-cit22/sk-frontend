                ...
                <div class="col-lg-9 order-lg-last order-1 tab-content">
                    <div class="tab-pane fade show active" id="dashboard" role="tabpanel">
                        <div class="dashboard-content">
                            <p>
                                Hello <strong class="text-dark">{{ auth()->user()->name }}!</strong>
                            </p>

                            <p>
                                From your account dashboard you can view your
                                <a class="btn btn-link link-to-tab" href="#order">recent orders</a>, manage your
                                <a class="btn btn-link link-to-tab" href="#address">shipping and billing addresses</a>, and
                            ...
                            <div class="row row-lg">
                                ...
                                <div class="col-6 col-md-4">
                                    ...
                                    <div class="feature-box text-center pb-1">
                                        <form action="{{ route('logout') }}" class="mb-3" method="POST">
                                            @csrf
                                            <button class="nav-link btn btn-link text-danger" type="submit"><i
                                                    class="sicon-logout"></i></button>
                                            <div class="feature-box-content">
                                                <h3>LOGOUT</h3>
                                            </div>
                                        </form>
