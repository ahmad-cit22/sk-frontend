                ...
                <div class="product-widgets-container row pb-2">
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/small/product-1.jpg') }}" width="84"
                                        height="84" alt="product">
                                    <img src="{{ asset('assets/images/products/small/product-1-2.jpg') }}" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/small/product-4.jpg') }}" width="84"
                                        height="84" alt="product">
                                    <img src="{{ asset('assets/images/products/small/product-4-2.jpg') }}" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/small/product-7.jpg') }}" width="84"
                                        height="84" alt="product">
                                    <img src="{{ asset('assets/images/products/small/product-7-2.jpg') }}" width="84"
                                        height="84" alt="product">
                                </a>
                            </figure>
                    ...
                    <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate" data-animation-name="fadeInLeftShorter"
                        ...
                        <div class="product-default left-details product-widget">
                            <figure>
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/small/product-10.jpg') }}" width="84"
                                        height="84" alt="product">
