...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 05:01:43 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Sk Corporation | Best RO Water Purifier In Bangladesh</title>
                ...
                <div class="container">
                    ...
                    <div class="header-right w-lg-max">
                        ...
                        <div class="header-contact d-none d-lg-flex pl-4 pr-4">
                            <img alt="phone" src="{{ asset('assets/images/phone.png') }}" width="30"
        ...
        <main class="main">
            <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase"
                ...
                <div class="home-slide home-slide1 banner">
                    <img class="slide-bg" src="{{ asset('assets/images/demoes/demo4/slider/slide-1.jpg') }}"
                ...
                <div class="banners-container mb-2">
                    <div class="banners-slider owl-carousel owl-theme"
                        ...
                        <div class="banner banner1 banner-sm-vw d-flex align-items-center appear-animate"
                            ...
                            <figure class="w-100">
                                <img src="{{ asset('assets/images/demoes/demo4/banners/banner-1.jpg') }}"
                        ...
                        <div class="banner banner3 banner-sm-vw d-flex align-items-center appear-animate"
                            ...
                            data-animation-delay="500">
                            <figure class="w-100">
                                <img src="{{ asset('assets/images/demoes/demo4/banners/banner-3.jpg') }}"
                                    alt="banner" width="380" height="175" />
                            </figure>
                ...
                <div class="container">
                    ...
                    <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center mb-2"
                        ...
                        <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                            <figure>
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/products/product-6.jpg') }}" width="220"
                    ...
                    <div class="product-widgets-container row pb-2">
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate"
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/products/small/product-4.jpg') }}"
                                            width="84" height="84" alt="product">
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate"
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/products/small/product-7.jpg') }}"
                                            width="84" height="84" alt="product">
                                        <img src="{{ asset('assets/images/products/small/product-7-2.jpg') }}"
                                            width="84" height="84" alt="product">
                                    </a>
                                </figure>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-5 pb-md-0 appear-animate"
                            ...
                            <div class="product-default left-details product-widget">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/products/small/product-10.jpg') }}"
                                            width="84" height="84" alt="product">
                                        <img src="{{ asset('assets/images/products/small/product-10-2.jpg') }}"
                                            width="84" height="84" alt="product">
                                    </a>
                                </figure>
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a
                                            href="https://portotheme.com/cdn-cgi/l/email-protection#f79a969e9bb7928f969a879b92d994989a"><span
                                                class="__cf_email__"
                                                data-cfemail="036e626a6f43667b626e736f662d606c6e">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
