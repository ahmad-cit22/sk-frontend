                ...
                <div class="col-lg-9">
                    <article class="post single">
                        <div class="post-media">
                            <img src="{{ asset('assets/images/blog') }}/post-1.jpg" alt="Post">
                        </div><!-- End .post-media -->
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-author">
                                ...
                                <figure>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/blog') }}/author.jpg" alt="author">
                                    </a>
                                </figure>
                            ...
                            <article class="post">
                                <div class="post-media zoom-effect">
                                    <a href="{{ route('single-blog', 1) }}">
                                        <img src="{{ asset('assets/images/blog/related') }}/post-1.jpg" alt="Post">
                                    </a>
                                </div><!-- End .post-media -->
                                ...
                                <div class="post-body">
                                    ...
                                    <h2 class="post-title">
                                        <a href="{{ route('single-blog', 1) }}">Post Format - Image</a>
                                    </h2>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <a href="{{ route('single-blog', 1) }}" class="read-more">read more <i
                        ...
                        <div class="widget">
                            ...
                            <ul class="simple-post-list">
                                <li>
                                    ...
                                    <div class="post-info">
                                        <a href="{{ route('single-blog', 1) }}">Top New Collection</a>
